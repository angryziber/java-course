...
public class XMLWriter implements AthleteWriter {
	...
	/** Initialise XML factory and create stream */
	@Override
	...
	/**
	 * Method form XML file by using competition and save it to stream After
	 * this method, it's needed to call <code>close()</code> method
	 * 
	 * @param comp
	 *            lint to competition with results and places
	 */
	@Override
