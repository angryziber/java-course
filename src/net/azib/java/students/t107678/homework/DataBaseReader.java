...
public class DataBaseReader implements Reader {
	...
	static final String statementByName = "select a.name, a.dob, a.country_code, r.race_100m, r.long_jump,r.shot_put,r.high_jump,r.race_400m," +
			" r.hurdles_110m, r.discus_throw, r.pole_vault, r.javelin_throw, r.race_1500m from athletes a, results r, competitions c " +
			"where a.id=r.athlete_id and r.competition_id=c.id and c.name=\'";


	boolean isParameterInt(String parameter) {
		try {
