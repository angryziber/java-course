...
public class Fibo {
	...
	static BigInteger Fnachi(int p){
		switch (p){
		case 1: LastPrev.setposl(BigInteger.ONE);LastPrev.setpredposl(BigInteger.ONE); return LastPrev.getPosl();
		case 2: LastPrev.setposl(BigInteger.ONE); return LastPrev.getPosl();
		default: break;
		}
