...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="athlete">
		...
		<tr>
			...
			<td>
				<b>
					<xsl:value-of select="hundredmeters"/>
				</b>
			</td>
			<td>
				<b>
			...
			<td>
				<b>
					<xsl:value-of select="fourhundredmeters"/>
				</b>
			</td>
			<td>
				<b>
					<xsl:value-of select="hurdles"/>
				</b>
			</td>
			<td>
				<b>
					<xsl:value-of select="discus"/>
				</b>
			</td>
			<td>
				<b>
