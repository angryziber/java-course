...
public class DecimalResult {
	 ...
	 */
	public static DecimalResult parseDouble(String str) throws BadDataFormatException {
		DecimalResult obj = new DecimalResult();
		try {
	 ...
	 * @return
	 */
	public static DecimalResult createObj(double value) {
		DecimalResult obj = new DecimalResult();
