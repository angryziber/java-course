...
/**
 * Unit test for the class {@link XmlResultsManager}
 */
public class XmlResultsManagerTest {
	/**
	 * Test for the method {@link XmlResultsManager#outputResults(String, ArrayList)}
	 */
	@Test
	public void outputResults()
	{
		...
		try
		{
			File fileTmp = new File("test.xml");
			fileTmp.deleteOnExit();

			XmlResultsManager manager = new XmlResultsManager();
