...
public class ControllerTest {
	...
	public void testArrangeInOrder() {
		...
		"Dunkle Jeremy,11.05.1960,DE,11.23,6.62,11.49,1.75,51.97,14.89,33.37,3.98,45.60,5:24.26", //2 6378    
		"Thomas Nathan,3.04.1972,ES,11.16,6.23,9.72,1.95,52.20,16.10,30.17,3.83,47.02,4:58.21", //4 6279    
		"Roth AJ,21.05.1981,US,11.48,6.03,14.67,1.85,53.94,17.84,41.23,3.68,56.71,4:31.15" //1 6615    
		};
	...
	public void testCalculatePoints() throws ParseException {
		...
		String[][] results = {
				...
				{"10.53","7.60","12.63","2.05","47.99","14.03","41.33","4.50","51.46","4:35.45","8072"},
				{"11.01","6.95","14.69","1.96","49.49","14.17","45.75","4.70","57.82","4:38.59","7980"},
				{"11.33","7.21","13.76","2.02","49.38","14.88","39.36","4.90","55.01","4:40.78","7762"}
				};
