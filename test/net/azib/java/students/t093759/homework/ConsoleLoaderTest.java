...
public class ConsoleLoaderTest {
	...
	public void consoleLoadingExample() throws IOException, StopLoadingAthletesException, SkipLoadingAthleteException {
		System.out.println(org.apache.commons.io.FileUtils.readFileToString(new File(getClass().getResource("input.console").getFile()),"UTF-8"));
		loader.in = getClass().getResourceAsStream("input.console");
		loader.localizedPatternOfDateOfBirth="dd.MM.yyyy";
		//System.out.println(loader.getStringFromInputStream());
		//System.out.println(loader.getStringFromInputStream());
