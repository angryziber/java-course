 ...
 * @author armin
 */
public class InputFromCSVTest {

	/**
	 * Test method for {@link net.azib.java.students.t092860.homework.InputFromCSV#get()}.
	 */
	@Test
	public final void testGet() {
		InputStreamMock inputMock = new InputStreamMock();
		InputFromCSV testObj = new InputFromCSV(inputMock);
